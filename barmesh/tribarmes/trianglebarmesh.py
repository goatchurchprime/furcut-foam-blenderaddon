...
print("reloading trianglebarmesh...")
        ...
        if trpts: # and len(trpts[0]) == 9:
            for i, tr in enumerate(trpts):
                if len(tr) == 9:
                    ...
                    assert (len(tr) == 3)
                    ipts.append((tr[0], i*3+0))
                    ipts.append((tr[1], i*3+1))
                    ipts.append((tr[2], i*3+2))
                jtrs.append([-1, -1, -1])
                self.ntriangles += 1
            ...
            for bar in self.bars:
                if bar.barforeright:
                    ...
                    if node2.i > bar.nodeback.i:
                        Dntriangles += 1
            if self.ntriangles != Dntriangles:
                print("-- triangle mismatch", self.ntriangles, Dntriangles, duplicatebarcount)
